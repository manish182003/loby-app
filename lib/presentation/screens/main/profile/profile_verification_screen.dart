...
class _ProfileVerificationScreenState extends State<ProfileVerificationScreen> {
  ...
  TextEditingController twitch =
      TextEditingController(text: 'https://www.twitch.tv/');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BodyPaddingWidget(
        child: profileController.profile.verifiedProfile ?? false
            ? Center(
                child: Column(
                    ...
                    children: [
                      Text(
                          ...
                          style: textTheme.headlineSmall
                              ?.copyWith(color: carminePinkColor)),
                      Text(
                          textAlign: TextAlign.start,
                      ...
                      Row(
                        ...
                        children: [
                          _documentTile(
                              ...
                              "Copy of your passport or ID card", onTap: () {
                            Helpers.showImagePicker(
                                context: context,
                                onGallery: _openFileExplorer,
                                onCamera: _docFromCamera);
                          }, isSelected: _paths.isEmpty, type: 'Document'),
                          SizedBox(width: 1.h),
                          _documentTile(textTheme,
                              "assets/icons/camera_icon.svg", "Selfie",
                              onTap: _imgFromCamera,
                              isSelected: imageFile.path.isEmpty,
                              type: 'Selfie'),
                        ],
                      ),
                      SizedBox(
                      ...
                      Align(
                        ...
                        child: SizedBox(
                          ...
                          child: CustomButton(
                            ...
                            onTap: () async {
                              if (profileController.profile.verifiedProfile ??
                                  false) {
                                Helpers.toast(
                                ...
                                if (_formKey.currentState!.validate()) {
                                  if (_paths.isEmpty ||
                                    ...
                                    Helpers.toast(
                                        "Please Upload Documents and Selfie");
                                  } else {
  ...
  Widget _documentTile(TextTheme textTheme, String icon, String title,
      {Function()? onTap, required bool isSelected, String? type}) {
          ...
          child: Column(
            ...
            children: [
              ...
              Text(isSelected ? title : '$type Selected',
                  textAlign: TextAlign.center,
                  style:
                      textTheme.titleMedium?.copyWith(color: textLightColor)),
            ],
          ),
        ),
      ),
