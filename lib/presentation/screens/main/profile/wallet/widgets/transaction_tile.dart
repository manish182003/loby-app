...
class TransactionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isTransactionOpenable = transaction.order != null &&
        transaction.order!.userGameService != null &&
        !isDebited &&
        !(['REFUND_OF_HOLDED_AMOUNT', 'FUND_ADDED']
            .contains(transaction.reason));
    return InkWell(
      onTap: () {
            ...
            children: [
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      Helpers.formatDateTime(dateTime: transaction.createdAt!),
                      style:
              ...
              Column(
                ...
                children: [
                    ...
                    children: [
                      Text(
                        ...
                        style: textTheme.displayMedium?.copyWith(
                            color:
                                isDebited ? carminePinkColor : textWhiteColor),
                  ...
                  SizedBox(
                    height: isTransactionOpenable ? 2.h : 0.0,
                  ),
                  isTransactionOpenable
                      ? InkWell(
                          onTap: () {
                            _transactionsDetails(context);
                          },
      ...
      builder: (BuildContext context) {
        ...
        if (transaction.order?.dispute == null) {
          totalAmount = (transaction.amount! * 100) /
              (100 -
                  ((transaction.order!.userGameService!.category!
                          .commissionPercent!) +
                      (transaction
                          .order!.userGameService!.category!.govtCommission!)));
          lobyProtectionCharges = (totalAmount *
                  transaction
                      .order!.userGameService!.category!.commissionPercent!) /
              100;
        } else {
          totalAmount = (transaction.amount! * 100) /
              (100 -
        ...
        double governmentCommission = (totalAmount *
                transaction.order!.userGameService!.category!.govtCommission) /
            100;
            ...
            child: Column(
              ...
              children: [
                ...
                _rowWidget(textTheme,
                    text1: 'Category',
                    text2: transaction.order!.userGameService!.category!.name!),
                SizedBox(height: 1.h),
                _rowWidget(textTheme,
                    text1: 'Game',
                ...
                SizedBox(height: 4.h),
                _rowWidget(textTheme,
                    text1: title.contains('Credited')
                        ? 'Tokens Earned'
                        : 'Tokens Spent',
                    text2: totalAmount.toStringAsFixed(2),
                    isToken: true,
                    isDebited: title.contains('Debited')),
                SizedBox(height: 1.h),
                _rowWidget(textTheme,
                    text1: 'Loby Protection Charges',
                    text2: lobyProtectionCharges.toStringAsFixed(2),
                    isToken: true,
                    isDebited: true),
                SizedBox(height: 1.h),
                _rowWidget(textTheme,
                    text1: 'Government Tax',
                    text2: governmentCommission.toStringAsFixed(2),
                    isToken: true,
                    isDebited: true),
                SizedBox(height: 1.h),
            ...
            ? Flexible(
                ...
                children: [
                  Text(
                    isDebited ? '-' : '+',
                    style: textTheme.displayMedium?.copyWith(
                        color: isDebited ? textErrorColor : aquaGreenColor),
                    textAlign: TextAlign.end,
                  ),
                  SizedBox(
                    width: 1.w,
