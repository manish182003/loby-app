...
class _MyListingTileState extends State<MyListingTile> {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: (){
        ...
        context.pushNamed(gameDetailPage, queryParams: {'serviceListingId' : "${widget.listing.id}", 'from' : 'myListing'});
      },
      child: Card(
  ...
  Widget _actionButton(TextTheme textTheme, {required String title, required Function() onTap, required Color color}){
    return TextButton(
      style: ButtonStyle(
