...
class _FilterBottomSheetState extends State<FilterBottomSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    listingController.rangeSliderDiscreteValues.value =
        RangeValues(0, listingController.maxFilterPrice.value.toDouble());
              ...
              SliderTheme(
                ...
                child: Obx(() {
                  return RangeSlider(
                    ...
                    labels: RangeLabels(
                      listingController.rangeSliderDiscreteValues.value.start
                          .round()
                          .toString(),
                      listingController.rangeSliderDiscreteValues.value.end
                          .round()
                          .toString(),
                    ),
                    onChanged: (values) {
                ...
                child: Obx(() {
                  return Row(
                    ...
                    children: [
                      TokenWidget(
                        text: Text(
                            '${listingController.rangeSliderDiscreteValues.value.start.floor()}',
                      ...
                      TokenWidget(
                        text: Text(
                            '${listingController.rangeSliderDiscreteValues.value.end.floor()}',
                            style: textTheme.headlineMedium
                                ?.copyWith(color: textWhiteColor)),
                        size: 20,
                      ),
                    ...
                    child: CustomButton(
                      ...
                      onTap: () {
                        ...
                        listingController.getBuyerListings(
                            ...
                            priceFrom: listingController
                                .rangeSliderDiscreteValues.value.start
                                .floor(),
                            priceTo: listingController
                                .rangeSliderDiscreteValues.value.end
                                .floor());
