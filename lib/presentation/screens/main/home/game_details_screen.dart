...
class _GameDetailScreenState extends State<GameDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final listing = listingController.buyerListings.where((categoryGame) => categoryGame.id == widget.serviceListingId).toList().first;

    return SafeArea(
      child: Scaffold(
        appBar: const PreferredSize(
          preferredSize: Size(double.infinity, 70),
          child: CustomAppBar(appBarName: "", txtColor: aquaGreenColor),
        ),
          ...
          child: BodyPaddingWidget(
            child: Column(
              children: [
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          _rowWidget(textTheme, text1: "Unit Price / Per ${listing.unit!.name}", text2: "${listing.price}", isNormal: true),
                          SizedBox(height: 1.h),
                          ...
                          Obx(() {
                            return Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () {
                                    if (listingController.quantityCount.value <
                                        listing.stockAvl!) {
                                      listingController.quantityCount.value++;
                                      listingController.totalPrice.value =
                                          (listing.price! *
                          ...
                          SizedBox(height: 1.h),
                          Obx(() {
                            return _rowWidget(textTheme, text1: "Total Price", text2: listingController.totalPrice.value,  isNormal: true);
                          }),
                          SizedBox(height: 1.h),
                          _rowWidget(textTheme, text1: "Earn Loby Coins", text2: "${listing.category?.lobyCoinsPercent}" ),
                          SizedBox(height: 1.h),
                        ],
                      ),
                    ),
                ...
                GestureDetector(
                  onTap: () {
                    context.pushNamed(otherUserPage, queryParams: {'userId': "${listing.user?.id}", 'from': 'other'});
                  },
                  child: Card(
                    color: backgroundBalticSeaColor,
                    elevation: 0.0,
                      ...
                      child: Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 4.0),
                            listing.user?.userFollowStatus == null ? const SizedBox() : Card(
                              shape: RoundedRectangleBorder(
