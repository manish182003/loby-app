  ...
  Widget build(BuildContext context) {
    ...
    return BodyPaddingWidget(
      child: Form(
        ...
        child: Column(
            children: [
              Text('Reset Password', style: textTheme.headline2?.copyWith(color: textWhiteColor)),
              SizedBox(height: 4.h,),
              Align(
                alignment: Alignment.centerLeft,
                  child: Text('Enter OTP', style: textTheme.headline4?.copyWith(color: textWhiteColor))),
              Padding(
              ...
              CustomButton(
                ...
                onTap: () async {
                  if (_formKey.currentState!.validate()) {
                    Helpers.loader();
                    final isSuccess = await authController.forgotAndResetPassword(email: widget.email, otp: otp.text, password: password.text, confirmPassword: confirmPassword.text);
                    if(isSuccess){
                      Helpers.hideLoader();
                      Navigator.pop(context);
                      Helpers.toast("Password Successfully Changed Please Login to Continue");
                    }else{
                      Helpers.hideLoader();
