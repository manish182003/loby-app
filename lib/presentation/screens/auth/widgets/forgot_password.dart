    ...
    return BodyPaddingWidget(
      child: Form(
        ...
        child: Column(
            children: [
              SizedBox(height: 2.h,),
              Text('Forgot Password', style: textTheme.headline2?.copyWith(color: textWhiteColor)),
              SizedBox(height: 4.h,),
              TextFieldWidget(
              ...
              CustomButton(
                ...
                onTap: () async {
                  if (_formKey.currentState!.validate()) {
                    Helpers.loader();
                    final isSuccess = await authController.forgotAndResetPassword(email: email.text);
                    if(isSuccess){
                      Helpers.hideLoader();
