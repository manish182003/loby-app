...
class UserModel extends User {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) => UserModel(
        ...
        bio: json["bio"],
        banTill:
            json["ban_till"] == null ? null : DateTime.parse(json['ban_till']),
        walletMoney: json["wallet_money"] == null
            ? null
            : double.tryParse(json["wallet_money"].toString()),
        verifiedProfile: json["verified_profile"],
        lobbyCoins: json["lobby_coins"],
        kycverify: json["kyc_verified"],
        ...
        coverImage: json["cover_image"] == null
            ? null
            : Helpers.getImage(json["cover_image"]),
        ...
        userFollowStatus: json["user_follow_status"] == 0
            ? 'N'
            : json["user_follow_status"] == null
                ? 'N'
                : 'Y',
        state:
        ...
        profileTags: json["profileTags"] == null
            ? []
            : json["profileTags"]
                .map<ProfileTagModel>(
                    (profileTags) => ProfileTagModel.fromJson(profileTags))
                .toList(),
        followStatus: json["userFollowingTo"] == null
            ? json["userFollowers"] == null
                ? null
                : json["userFollowers"]["followStatus"] == 0
                    ? 'N'
                    : 'Y'
