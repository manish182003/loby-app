...
abstract class AuthRemoteDatasource {
  ...
  Future<bool> login(String? mobile, String? email, String? password,
      String? socialLoginId, int? socialLoginType, String? name);

  Future<CountryResponseModel> getCountries(String? name, int? page);

  Future<StateResponseModel> getStates(
      String? search, int? stateId, int? countryId, int? page);

  Future<CityResponseModel> getCities(
      String? search, int? stateId, int? cityId, int? page);
  ...
  Future<Map<String, dynamic>> forgotAndResetPassword(
      String? email, String? otp, String? password, String? confirmPassword);
  Future<Map<String, dynamic>> deleteAccount(int userId);
}
