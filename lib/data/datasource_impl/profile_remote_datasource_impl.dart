...
class ProfileRemoteDatasourceImpl extends ProfileRemoteDatasource {
  ...
  @override
  Future<Map<String, dynamic>> verifyPayment(String? signature,
  ...
  @override
  Future<Map<String, dynamic>> profileVerification(
      String? displayName,
      String? name,
      String? message,
      String? youtube,
  ...
  Future<BankDetailResponseModel> getBankDetails() async {
    try {
      ...
      final response = await Helpers.sendRequest(
        ...
        // extra: {'instagram_id': insta ?? "", 'youtube_id' : youtube ?? "", 'twitch_id' : twitch ?? "", 'discord_id' : discord ?? ''},
        headers: headers,
      );
  ...
  Future<Map<String, dynamic>> withdrawMoney(
      int? bankDetailId, int? amount) async {
    try {
      final headers = await Helpers.getApiHeaders();
      final response = await Helpers.sendRequest(
        _dio,
  ...
  @override
  Future<PaymentTransactionResponseModel> getPaymentTransactions(
      int? page) async {
    try {
      final headers = await Helpers.getApiHeaders();
      final response = await Helpers.sendRequest(
  ...
  Future<Map<String, dynamic>> submitFeedback(
      String? feedback, String? email) async {
    try {
      final headers = await Helpers.getApiHeaders();
  ...
  @override
  Future<SettlementRequestResponseModel> getSettlementRequests(
      int? page, String? type) async {
    try {
      final headers = await Helpers.getApiHeaders();
      final response = await Helpers.sendRequest(
  ...
  @override
  Future<WalletTransactionResponseModel> getEarningTransactions(
      int? page, String? type) async {
    try {
      final headers = await Helpers.getApiHeaders();
      final response = await Helpers.sendRequest(
