...
class AuthRepositoryImpl extends AuthRepository {
  ...
  Future<Either<Failure, Map<String, dynamic>>> signup(
    ...
    try {
      return Right(await _authRemoteDatasource.signup(
  ...
  Future<Either<Failure, StateResponse>> getStates(
      ...
      int? page}) async {
    try {
      return Right(await _authRemoteDatasource.getStates(
          search, stateId, countryId, page));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  Future<Either<Failure, CityResponse>> getCities(
    ...
    try {
      return Right(
          await _authRemoteDatasource.getCities(search, stateId, cityId, page));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  Future<Either<Failure, bool>> updateProfile(
      ...
      String? email}) async {
    try {
      return Right(await _authRemoteDatasource.updateProfile(
          cover,
          avatar,
          fullName,
          displayName,
  ...
  Future<Either<Failure, bool>> login(
      ...
      String? name}) async {
    try {
      return Right(await _authRemoteDatasource.login(
          mobile, email, password, socialLoginId, socialLoginType, name));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  @override
  Future<Either<Failure, Map<String, dynamic>>> addFCMToken(
  ...
  Future<Either<Failure, Map<String, dynamic>>> forgotAndResetPassword(
      ...
      String? confirmPassword}) async {
    try {
      return Right(await _authRemoteDatasource.forgotAndResetPassword(
  ...
  Future<Either<Failure, Map<String, dynamic>>> deleteAccount(
      int userid) async {
    try {
      return Right(await _authRemoteDatasource.deleteAccount(userid));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
