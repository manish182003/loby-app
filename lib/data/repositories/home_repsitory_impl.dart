...
class HomeRepositoryImpl extends HomeRepository {
  ...
  Future<Either<Failure, CategoryResponse>> getCategories(
    ...
    try {
      return Right(
          await _homeRemoteDatasource.getCategories(name, page, categoryId));
  ...
  @override
  Future<Either<Failure, GameResponse>> getGames(
  ...
  @override
  Future<Either<Failure, CategoryGamesResponse>> getCategoryGames(
      {int? categoryId, String? search}) async {
    try {
      return Right(
          await _homeRemoteDatasource.getCategoryGames(categoryId, search));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  Future<Either<Failure, NotificationResponse>> getNotifications(
    ...
    try {
      return Right(
          await _homeRemoteDatasource.getNotifications(notificationId, page));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  @override
  Future<Either<Failure, Map<String, dynamic>>> deleteNotification(
      {int? notificationId}) async {
    try {
      return Right(
          await _homeRemoteDatasource.deleteNotification(notificationId));
    } on ServerException catch (e) {
      // Loggers can be added here for analyzation.
      return Left(ServerFailure(message: e.message.toString()));
    }
  ...
  @override
  Future<Either<Failure, GlobalSearchResponse>> globalSearch(
      {String? search}) async {
    try {
